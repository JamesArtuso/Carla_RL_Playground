...
from planning.safe_rl.worker.on_policy_worker import OnPolicyWorker
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cont43.7551264230841inue_scenario_training', '-cst', type=bool, default=False)
    ...
    agent_config['ego_state_dim'] = 128
    ...
    worker =  OnPolicyWorker(env, test_model, logger , **agent_config['ppo']['worker_config'])
